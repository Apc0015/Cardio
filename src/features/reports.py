...
"""
    ...
    if predictor:
        ...
        if risk_pct < 30:
            ...
            risk_cat = "Moderate-Low Risk ⚠️"
        elif risk_pct < 70:
            risk_cat = "Moderate-High Risk ⚠️"
        else:
            risk_cat = "High Risk 🚨"
        report += f"  {risk_cat}\n\n"
...
This report is generated by CardioFusion, a cardiovascular disease risk
assessment tool. This tool is for educational and informational purposes
...
© 2024 CardioFusion. All rights reserved.
================================================================================
"""
...
def render_reports_page(prediction, patient_data, input_data, predictor):
    ...
    with tab3:
        ...
        **Available Export Formats:**
        - ✅ **Text Report (.txt)** - Ready to download
        - ✅ **JSON Data (.json)** - Machine-readable format
        - 🔜 **PDF Report (.pdf)** - Coming soon
        - 🔜 **CSV Data (.csv)** - Coming soon
        """)
        ...
        if st.button("📧 Email Report", disabled=True):
            st.warning("Email functionality coming soon!")

        st.caption("💡 For now, you can download the report and email it manually to your healthcare provider.")
